...
#from pylog import * # Seems reasonable; but might not need 
...
#from rules.production import IF, AND, OR, NOT, THEN, DELETE, forward_chain, pretty_goal_tree
...
# Key...values
# How do I want the raw data 

# We may not want to use a priority quque
